...
# path_human = 'D:/CodeAI/AI/task_7_demo_NN/Human'
# part_non_human = 'D:/CodeAI/AI/task_7_demo_NN/Non-Human'
...
for file in os.listdir(path_human):
  ...
  fd, image_human = hog(image_human, orientations=8, pixels_per_cell=(16, 16),
...
for file in os.listdir(part_non_human):
  ...
  fd, image_non_human = hog(image_non_human, orientations=8, pixels_per_cell=(16, 16),
                        cells_per_block=(1, 1), visualize=True, multichannel=False)
